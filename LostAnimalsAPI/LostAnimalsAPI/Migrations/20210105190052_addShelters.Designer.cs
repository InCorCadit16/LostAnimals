...
namespace LostAnimalsAPI.Migrations
{
    ...
    [Migration("20210105190052_addShelters")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LostAnimalsAPI.Models.Comment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LostAnimalsAPI.Models.Shelter", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LostAnimalsAPI.Models.Location", b =>
                {
                    b.HasOne("LostAnimalsAPI.Models.Comment", "Comment")
                        .WithOne("Location")
                        .HasForeignKey("LostAnimalsAPI.Models.Location", "CommentId");

                    b.HasOne("LostAnimalsAPI.Models.Post", "Post")
                        .WithOne("Location")
                        .HasForeignKey("LostAnimalsAPI.Models.Location", "PostId");

                    b.HasOne("LostAnimalsAPI.Models.Shelter", "Shelter")
                        .WithOne("Location")
                        .HasForeignKey("LostAnimalsAPI.Models.Location", "ShelterId");
                });
